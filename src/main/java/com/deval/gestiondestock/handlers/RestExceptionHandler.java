package com.deval.gestiondestock.handlers;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    //TODO HandleInvalidOperationExeception
    ...
    public ResponseEntity<ErrorDto> handleException(BadCredentialsException exception, WebRequest webRequest){
        ...
        final ErrorDto errorDto = new  ErrorDto();
            ...
            errorDto.setErrors(Collections.singletonList("Login et / ou le mot de passe incorrecte"));
/*                .code(ErrorCodes.BAD_CREDENTIALS)
                .httpCode(badRequest.value())
                .message(exception.getMessage())
                .errors(Collections.singletonList("Login et / ou le mot de passe incorrecte"));*/
        return new ResponseEntity<>(errorDto, badRequest);
    }
}
